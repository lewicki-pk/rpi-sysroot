...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS=' -I/usr//include   -I/usr/include/infiniband -I/usr/include/infiniband' FFLAGS='-g -O2 -fstack-protector-strong' LDFLAGS='-Wl,-z,relro  -L/usr//lib' --enable-shared --disable-static  --prefix=/usr --with-mpi=open_mpi --disable-aio"
...
#define OPAL_ASM_SUPPORT_64BIT 0
...
#define OPAL_ASSEMBLY_ARCH OMPI_ARM

/* Format of assembly file */
#define OPAL_ASSEMBLY_FORMAT "default-.text-.globl-:--.L-#-1-1-1-0-1"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 4.9.1
...
#define OPAL_PACKAGE_STRING "Open MPI root@plugwash.raspbian.lan Distribution"
